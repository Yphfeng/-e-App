		...
		return (
			<View style={{flex: 1,backgroundColor: "#FFF"}}>
				...
				<View style={styles.content}>
					<Image source={require("../../../img/dySuccess.png")} resizeMode="cover" style={styles.img} />
					<Text style={{fontSize: 18, paddingTop: 20, paddingBottom: 20,}}>评论成功</Text>
					<Text>评论审核中</Text>
				</View>
...
export default connect(mapStateToProps, mapDispatchToProps)(CommentSuccess)
