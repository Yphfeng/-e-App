...
var _that;
class TiwenObserve extends Component 
{
	...
	renderWebView()
	{
		...
		let uri = URL + "wxdata/bodyTemperatureData.html?token=" + tokend + "&sn=" + sn + "&time=" + this.time + "&version=app";
...
export default connect(mapStateToProps, mapDispatchToProps)(TiwenObserve)
