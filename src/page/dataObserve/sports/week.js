        ...
        return (
            <View style={{flex: 1,backgroundColor: '#24a090',paddingLeft: 15,paddingRight: 15}}>
                <View style={styles.topView}>
                    <Text style={{color: '#fff',paddingBottom: 20}}>本周(02/18-02/24)</Text>
                    <Text style={[{fontSize: 24,fontWeight: 'bold'},styles.white]}>0</Text>
                    <Text style={styles.white}>总里程(km)</Text>
                    <View style={styles.sportsData}>
                        <View style={styles.dataItem}>
                            <Text style={styles.white}>0</Text>
                            <Text style={styles.white}>步行数</Text>
                        </View>
                        <View style={styles.dataItem}>
                            <Text style={styles.white}>0</Text>
                            <Text style={styles.white}>卡路里</Text>
                        </View>
                    </View>
                </View>
                <View style={styles.tips}>
                    <Text style={{color: '#ccc'}}>运动周报</Text>
                    <Text style={{paddingTop: 10}}>本周平均每日行走步数还未达标</Text>
                </View>
