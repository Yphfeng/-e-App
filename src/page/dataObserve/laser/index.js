...
export default class LaserPage extends Component {
    static navigationOptions = {
        ...
        tabBarIcon: ({focused}) => {
            if (focused) {
                return (
                    <Image style={styles.tabBarIcon} source={require('../../../img/jgsel.png')}/>
                );
            }
            return (
                <Image style={styles.tabBarIcon} source={require('../../../img/jg.png')}/>
            );
        },
    };
