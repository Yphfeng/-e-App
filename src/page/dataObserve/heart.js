...
var _that;
class HeartObserve extends Component
{
	...
	renderWebView()
	{
		...
		let uri = URL + "wxdata/heartRateData.html?token=" + tokend + "&sn=" + sn + "&time=" + this.time + "&version=app";
...
export default connect(mapStateToProps, mapDispatchToProps)(HeartObserve)
