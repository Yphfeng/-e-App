...
var _that;
class DataObserve extends Component
{
	...
	renderWebView()
	{
		...
		let uri = URL + "wxdata/dataApp.html?token=" + tokend + "&sn=" + sn + "&time=" + this.time + "&version=app";
...
export default connect(mapStateToProps, mapDispatchToProps)(DataObserve)
