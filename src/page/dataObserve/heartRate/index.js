...
export default class HeartRatePage extends Component {
    static navigationOptions = {
        ...
        tabBarIcon: ({focused}) => {
            if (focused) {
                return (
                    <Image style={styles.tabBarIcon} source={require('../../../img/xinlvSelected.png')}/>
                );
            }
            return (
                <Image style={styles.tabBarIcon} source={require('../../../img/xinlv.png')}/>
            );
        },
    };
