...
var _that;
class LaserObserve extends Component
{
	...
	renderWebView()
	{
		...
		let uri = URL + "wxdata/laserData.html?token=" + tokend + "&sn=" + sn + "&time=" + this.time + "&version=app";
...
export default connect(mapStateToProps, mapDispatchToProps)(LaserObserve)
