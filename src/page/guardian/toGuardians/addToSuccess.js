...
class AddToSuccess extends Component
{
	...
	send = () => {
		this.props.navigation.navigate("ToGuardianList");
	}
...
export default connect(mapStateToProps, mapDispatchToProps)(AddToSuccess)
