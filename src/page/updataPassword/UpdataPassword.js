...
let sHeight = StatusBar.currentHeight;
export default class UpdataPasswordPage extends Component {
                ...
                <TouchableOpacity style={styles.container} onPress={this.onBlur} activeOpacity={1}>
                    ...
                    <View style={styles.topView}>
                        <View style={styles.itemContainer}>
                            ...
                            <TextInput style={styles.inputText} maxLength={11} underlineColorAndroid="transparent" placeholder="请输入您的手机号码" onChangeText={this.onChangeEmailText.bind(this)} />
                        </View>
                        <View style={styles.itemContainer}>
                            <View style={styles.textLabel}>
